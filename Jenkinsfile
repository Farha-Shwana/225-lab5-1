pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/YOURNAME'                         //<------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/YOURNAME/YOURREPO.git' //<------change this
        KUBECONFIG = credentials('YOURNAME-225-sp26')            //<------change this
    }
    stages {
        stage('Checkout') {
            steps {
